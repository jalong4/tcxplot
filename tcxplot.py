...
optional arguments:
  ...
  --no_browser: disables the launch the webview on the resulting HTML file
...
def main():
    ...
    parser.add_argument('--no_browser', dest='launch_browser', action='store_false', help='Do not launch the webview on the resulting html file')
